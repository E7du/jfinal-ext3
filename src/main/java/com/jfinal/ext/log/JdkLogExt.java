 ...
 * @author BruceZCQ
 */
public class JdkLogExt extends Logger {

	private java.util.logging.Logger log;
	private String clazzName;
	
	JdkLogExt(Class<?> clazz) {
		log = java.util.logging.Logger.getLogger(clazz.getName());
		clazzName = clazz.getName();
	}
	
	JdkLogExt(String name) {
		log = java.util.logging.Logger.getLogger(name);
		clazzName = name;
	}
	
	public static JdkLogExt getLogger(Class<?> clazz) {
		return new JdkLogExt(clazz);
	}
	
	public static JdkLogExt getLogger(String name) {
		return new JdkLogExt(name);
	}
