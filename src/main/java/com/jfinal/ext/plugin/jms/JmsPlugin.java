...
public class JmsPlugin implements IPlugin {
    ...
    private final Log LOG = Log.getLog(JmsPlugin.class);
    ...
    private void initServerConfig() {
        ...
        LOG.debug("serverUrl : " + serverUrl + " ,username : " + username + " ,password : " + password);
    }

    private void initReceiver() {
        String receiveQueues = JmsConfig.getStr("receiveQueues");
        LOG.debug("receiveQueues :" + receiveQueues);
        ...
        LOG.debug("receiveTopic :" + receiveTopics);
    ...
    private void initSender() {
        ...
        LOG.debug("sendQueues :" + sendQueues);
        ...
        LOG.debug("sendTopics :" + sendTopics);
