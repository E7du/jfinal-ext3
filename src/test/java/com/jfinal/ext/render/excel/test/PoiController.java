...
public class PoiController extends Controller {
    ...
    public void columns() {
        ...
        render(ExcelRender.me(data).fileName("your_file_name.xls").headers(headers2).sheetName("ok").columns(columns).cellWidth(5000).headerRow(2));
    }
    ...
    public void map() {
        ...
        render(ExcelRender.me(data).columns(columns).sheetName("ok").headers(headers));
    }
    ...
    public void record() {
        ...
        render(ExcelRender.me(data).headers(headers2));
    }
